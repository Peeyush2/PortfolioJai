                            ...
                            <div className="work2-container2">
                                <div className="work2-mainImg-preDiv">
                                    <div className="work2-mainImg">
                                        <img style={{border:props.imgBorder}} onPointerUp={()=>setisPointerDown(false)} onPointerMove={e=>handlePointerMove(e)} onPointerDown={e=>handlePointDown(e)} src={img.imgUrl}></img>
                                        {/* <img.imgUrl/> */}
