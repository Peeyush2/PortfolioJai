        ...
        <div className="MessageMe">
            <div className="MessageMe-container">
                    {idx==0 && <div className="MessageMe-Form">
                        Fill in the Details
                        <br/><input value={name} onChange={(e)=>setname(e.target.value)} placeholder="Name"/>
                        <br/><input value={email} onChange={(e)=>setemail(e.target.value)} placeholder="email"/>
                    ...
                    {idx==1 && <div className="MessageMe-Form">
                        ...
                        <br/><input value={otp} onChange={(e)=>otpChange(e.target.value,otp,setotp,otpGen,setError)} placeholder="OTP"/>
